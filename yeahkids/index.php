...
<!--Template Generator --> <!--.com/html/yeahkids/read, Mon, 08 Oct 2018 13:32:16 GMT -->
<head>
	<meta charset="utf-8">
...
<!-- END Background swither -->
					...
					<div class="row">
						...
						<div class="about_text_block">
							<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<p><span>Totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</span></p>
							</div>
			...
			<section id="timer" class="timer text-center" data-parallax="scroll" data-bleed="200" data-z-index="-100" data-speed="0.1" data-image-src="img/home/timer_bg.jpg" data-over-scroll-fix="true">
				...
				<div class="container timer_block">
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<h2 class="section-title">FIRST DAY AT SCHOOL !</h2>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 col-sm-12">
							...
							<div class="timer_button">
								<p><a class="b_green_light" href="event.html">Read more</a></p>
							</div>	
						</div>
					</div>
					<div class="row event_block">
						...
						<div class="col-md-4 col-sm-12 wow fadeInRight">
							<div class="view_events">
								...
								</svg><a href="events.html">View All events</a></p>
							</div>
						</div>
					</div>
				</div>
			...
			<section id="rates" class="rates">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-4 col-sm-12 rates_block basic_block wow fadeInLeft">
						...
						<div class="col-md-4 col-sm-12 rates_block popular_block wow fadeInUp">
							<div class="text_block">
								<div class="rates_popular_banner"></div>
								<div class="rates_name">
						...
						<div class="col-md-4 col-sm-12 rates_block premium_block wow fadeInRight">
							<div class="text_block">
								<div class="rates_name">
										...
										<div class="col-md-6 col-sm-12">
											...
											<div class="contact_form contact_form_transparent">
												<form method="post" id="contact_form">
													...
													<textarea id="message" name="message" rows="3" placeholder="Text"></textarea>
